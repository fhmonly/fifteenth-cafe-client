...
const notEmpty = () => !!cart.value.length;

</script>

<template>
    <div class="checkout-wrapper sticky bg-main bottom-2 rounded-[7px] flex p-2 items-center mx-2" v-show="notEmpty()">
        <div class="flex items-center checkout-cart grow">
